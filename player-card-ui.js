...
export async function viewPlayerCard(targetUsername) {
    ...
    <style>
        ...
        .card-bleed-edge { position: absolute; inset: 0; background: radial-gradient(circle, rgba(255,255,255,0.06) 1.5px, transparent 1.5px) 0 0, #141414; background-size: 8px 8px; border: 1px solid #222; }
