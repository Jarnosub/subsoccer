...
window.mobileAddPlayer = function(defaultName, userId) {
    ...
    div.style.cssText = 'display: flex; align-items: center; background: #f4f4f4; padding: 6px; border-radius: 2px; border: none; border-bottom: 1px solid rgba(255,255,255,0.2); margin-bottom: 8px;';
    div.innerHTML = `
