...
let user = null, pool = [], sessionGuests = [], allDbNames = [], allGames = [];
        ...
        list.innerHTML = data.map(game => `
            <div style="background:#111; padding:15px; border-radius:8px; margin-bottom:10px; border-left: 3px solid var(--sub-red); position: relative;">
                <div style="position: absolute; top: 10px; right: 10px;">
                    <button style="background: none; border: none; cursor: pointer; font-size: 1rem; margin-right: 5px; color: #ccc;">✏️</button>
