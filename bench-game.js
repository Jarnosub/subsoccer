...
window.isPlaying = false;
    ...
    const goal = {
        x: 0,
        y: 100, // Center of goal Y (lower)
        z: 1200, // Far back wall
        w: 2400,  // Width of goal
        h: 500   // Height of goal (lower ceiling)
    };
    ...
    function gameLoop() {
        ...
        balls.forEach(b => {
            ...
            // Subsoccer Ceiling: The plexiglass top of the bench prevents high balls
            if (b.y < -150) {
                b.y = -150;
                b.vy *= -0.4; // Bounce downwards
            }
